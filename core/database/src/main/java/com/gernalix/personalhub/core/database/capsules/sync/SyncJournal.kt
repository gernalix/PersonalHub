...
object SyncJournal {
    val excluded = setOf("room_master_table", "android_metadata", "hub_generation", "hub_sync_pending", "hub_sync_known", "sync_queue", "sync_shadow", "sync_meta", "hub_activity_undo_context", "hub_git_pending", "hub_git_events", "hub_git_edit_context", "hub_git_applied_patches", "hub_git_history_index", "hub_git_history_field_stats")
